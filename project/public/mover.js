class Mover {
	...
	move() {
		...
		this.x += (p.x / randomGaussian(0.9, 0.3) + randomGaussian(0, 0.000001)) * MULTIPLIER;
		this.y += (p.y / randomGaussian(0.9, 0.3) + randomGaussian(0, 0.000001)) * MULTIPLIER;
...
function superCurve(x, y, scl1, scl2, a1, a2, seed) {
	...
	let v = map(vn, -1.0005, 1.05, -15, 25, true);
