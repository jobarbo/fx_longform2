	...
	constructor() {
		...
		this.effectsConfig = {
			...
			crtDisplay: {
				...
				gapOpacity: 0.1, // Gap opacity between phosphor dots (0.0 = no gaps, 1.0 = full dark gaps)
				rgbOpacity: 0.01, // RGB color separation opacity (0.0 = no separation, 1.0 = full RGB isolation)
				dotRadius: 0.6, // Size of phosphor dots (0.0-0.5, smaller = larger gaps)
				dotFalloff: 0.5, // Softness of phosphor dot edges (0.0 = sharp, 1.0 = very soft)
