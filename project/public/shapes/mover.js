...
const FELT_SKIPPER_OFFSET = 2.5;
const FELT_SIZE_KNOTS = [
	[0, FELT_REFERENCE_PARTICLE_SIZE * (0.2 * FELT_SKIPPER_OFFSET)],
	[0.0005, FELT_REFERENCE_PARTICLE_SIZE * (0.1 * FELT_SKIPPER_OFFSET)],
	[0.0015, FELT_REFERENCE_PARTICLE_SIZE * (0.4 * FELT_SKIPPER_OFFSET)],
	[0.005, FELT_REFERENCE_PARTICLE_SIZE * (0.3 * FELT_SKIPPER_OFFSET)],
	[0.015, FELT_REFERENCE_PARTICLE_SIZE * (0.2 * FELT_SKIPPER_OFFSET)],
	[0.025, FELT_REFERENCE_PARTICLE_SIZE * (0.1 * FELT_SKIPPER_OFFSET)],
	[0.05, FELT_REFERENCE_PARTICLE_SIZE * (0.15 * FELT_SKIPPER_OFFSET)],
	[0.075, FELT_REFERENCE_PARTICLE_SIZE * (0.05 * FELT_SKIPPER_OFFSET)],
	[0.1, FELT_REFERENCE_PARTICLE_SIZE * (0.1 * FELT_SKIPPER_OFFSET)],
	[0.15, FELT_REFERENCE_PARTICLE_SIZE * (0.15 * FELT_SKIPPER_OFFSET)],
	[0.2, FELT_REFERENCE_PARTICLE_SIZE * (0.2 * FELT_SKIPPER_OFFSET)],
	[0.3, FELT_REFERENCE_PARTICLE_SIZE * (0.4 * FELT_SKIPPER_OFFSET)],
	[0.4, FELT_REFERENCE_PARTICLE_SIZE * (0.6 * FELT_SKIPPER_OFFSET)],
...
class Mover {
	constructor(x, y, scl1, scl2, scl3, sclOffset1, sclOffset2, sclOffset3, amplitude1, amplitude2, xMin, xMax, yMin, yMax, isBordered, rseed, nseed, preCalculatedPalette) {
		...
		this.wrapPaddingY = (min(width, height) * wrapPaddingFactor) / height;
